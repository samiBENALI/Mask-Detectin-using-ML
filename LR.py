...
def data_flat_split():
    ...
    train_set_x_orig= np.array(x_list[0:200])
    train_set_y = np.array(y_list[0:200])
    train_classes=np.array(class_list[0:200])
    test_set_x_orig = np.array( x_list[200:])
    test_set_y = np.array(y_list[200:])
    test_classes = np.array(class_list[200:])
