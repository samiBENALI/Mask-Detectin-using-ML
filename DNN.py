...
DIRECTORY = r"C:\Users\sam\Desktop\Logistic Regression\dataset"
...
parameters = two_layer_model(train_set_x_flatten,train_set_y, layers_dims = (n_x, n_h, n_y), num_iterations = 2500, print_cost=True)

predictions_train = predict(train_set_x_flatten,train_set_y, parameters)
predictions_test = predict(test_set_x_flatten,test_set_y, parameters)
